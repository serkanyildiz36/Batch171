...
//public static void main (string)[]args) psvm yada main yazılabilir.

           // variables:nasıl oluşturulur:

/*Data Taype  +  variables name +  atama operatörü(assigment operatörü)+ variable degeri+noktalı virgül
 ...
 int          +    age                    =                                   13            ;
    ...
    //   String ogrenciAdi = "Ali Can" ;
        ...
        /*
        *String variable olusturdugumuzda cogu zaman ona bir deger atari. Atama yapmazsak java o
        * varibale icin varsayilan
