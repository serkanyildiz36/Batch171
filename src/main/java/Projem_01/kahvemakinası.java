...
public class kahvemakinası {
  ...
  String boyut oluşturun...
       ...
       HERKESE KOLAY GELSİN !! :)
        ...
        if (hangikahve.equals("Türkkahvesi")) {
            System.out.println("Türk kahvesi hazırlanıyor.");

        } else if (hangikahve.equals("filitre kahve.")) {
            System.out.println("filitre kahveniz hazırlanıyor.");

        } else if (hangikahve.equals("Expresso")) {
            System.out.println("Expresso kahveniz hazırlanıyor");
        }
...
//2koşul:
        ...
        if (sut.equals("evet")) {
            System.out.println("süt eklenitor");
...
//******************************************************************************
        System.out.println("şeker istermisiniz(evet veya hayır cevabını veriniz");

        String şeker = input.nextLine();

        şeker = şeker.toLowerCase();

        if (şeker.equals("evet")) {

            System.out.println("kaç şeker olsun");

            int kacşeker = input.nextInt();

            String şekerboş = input.nextLine();
            ...
            System.out.println("şeker eklen miyor");
        }
//******************************************************************
